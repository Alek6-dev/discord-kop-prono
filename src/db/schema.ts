...
export const grandPrix = pgTable("grand_prix", {
  ...
  raceStartsAt: timestamp("race_starts_at", { withTimezone: true }).notNull(),
  qualifyingStartsAt: timestamp("qualifying_starts_at", { withTimezone: true }),
  sprintStartsAt: timestamp("sprint_starts_at", { withTimezone: true }),
  sprintQualifyingStartsAt: timestamp("sprint_qualifying_starts_at", { withTimezone: true }),
